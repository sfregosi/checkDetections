...
% below is some code that takes a checked log and reorganizes it, cleans
% it, and summarizes the true positives. It was implemented for the 2018
% GoMex glider mission, to quantify glider noise. 
% 
% It has not been tested/optimized in many years so not sure it would still
% work, but want to save it here in case! 
